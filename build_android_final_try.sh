...
apt-get install -y -qq -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold" openjdk-21-jdk-headless unzip wget curl
...
/opt/gradle-8.13/bin/gradle assembleDebug --no-daemon --max-workers=1 > /tmp/build_final_try.log 2>&1
echo "Build finished."

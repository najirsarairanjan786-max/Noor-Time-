    ...
    >
      ...
      <div className="glass-panel p-2">
        ...
        <div className="p-4 flex items-center justify-between border-b border-emerald-800/40">
          ...
          <button
            onClick={() =>
              setSettings((p) => ({ ...p, alarmsEnabled: !p.alarmsEnabled }))
            }
            className={`w-12 h-6 rounded-full transition-colors relative ${settings.alarmsEnabled ? "bg-emerald-500" : "bg-emerald-900"}`}
          >
            <div
              className={`w-4 h-4 rounded-full bg-white absolute top-1 transition-all ${settings.alarmsEnabled ? "left-7" : "left-1"}`}
            ></div>
          </button>
        </div>
          ...
          <>
            ...
            <div className="p-4 flex items-center justify-between border-b border-emerald-800/40 bg-emerald-900/10">
              ...
              <select
                ...
                onChange={(e) =>
                  setSettings((p) => ({
                    ...p,
                    alarmSound: e.target.value as any,
                  }))
                }
            ...
            <div className="p-4 flex items-center justify-between border-b border-emerald-800/40 bg-emerald-900/10">
              ...
              <select
                ...
                onChange={(e) =>
                  setSettings((p) => ({
                    ...p,
                    preAlarmMinutes: Number(e.target.value),
                  }))
                }
                className="bg-emerald-950 border border-emerald-800 text-emerald-100 text-sm rounded-lg p-2 outline-none"
              >
            ...
            <div className="p-4 flex flex-col gap-2 border-b border-emerald-800/40 bg-emerald-900/10">
              ...
              {["Fajr", "Zuhr", "Asr", "Maghrib", "Isha"].map((prayer) => (
                <div
                  key={prayer}
                  className="flex items-center justify-between ml-12 mr-4 bg-emerald-950 p-2 rounded-lg border border-emerald-800/50"
                >
                  <span className="text-emerald-100 text-sm w-16">
                    {prayer}
                  </span>
                  <select
            ...
            <div className="p-4 flex flex-col border-b border-emerald-800/40 bg-emerald-900/10">
              ...
              {Object.entries(settings.customAlarms || {}).map(
                ([name, time]) => (
                  <div
                    key={name}
                    className="flex items-center justify-between ml-12 mr-4 mb-2 bg-emerald-950 p-2 rounded-lg border border-emerald-800/50"
                  >
                    <div className="flex items-center gap-3">
                      <span className="text-emerald-100 text-sm">{name}</span>
                      <span className="text-emerald-400/80 text-xs bg-emerald-900/50 px-2 py-0.5 rounded">
                        {time}
                      </span>
                    </div>
                    <button
                      onClick={() => removeCustomAlarm(name)}
        ...
        <div className="p-4 flex items-center justify-between border-b border-emerald-800/40">
          ...
          <select
            ...
            onChange={(e) =>
              setSettings((p) => ({ ...p, method: Number(e.target.value) }))
            }
        ...
        <div className="p-4 flex items-center justify-between border-b border-emerald-800/40">
          ...
          <select
            ...
            onChange={(e) =>
              setSettings((p) => ({ ...p, school: Number(e.target.value) }))
            }
            className="bg-emerald-950 border border-emerald-800 text-emerald-100 text-sm rounded-lg p-2 outline-none"
          >
        ...
        <div className="p-4 flex items-center justify-between border-b border-emerald-800/40">
          <div className="flex items-center gap-3 text-emerald-100">
            ...
            <div>
              ...
              <div className="text-[10px] text-emerald-400/60 uppercase">
                Date changes at 7 PM
              </div>
            </div>
          </div>
          <select
            ...
            onChange={(e) => {
              ...
              setSettings((p) => ({
                ...p,
                hijriOffset: Number(e.target.value),
              }));
            }}
            className="bg-emerald-950 border border-emerald-800 text-emerald-100 text-sm rounded-lg p-2 outline-none"
          >
        ...
        <div
          className="p-4 flex items-center justify-between cursor-pointer hover:bg-emerald-800/20 transition"
            ...
            {user ? (
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="py-2 px-4 bg-emerald-600 text-white text-xs font-semibold rounded hover:bg-emerald-500 transition-colors shadow-md shadow-emerald-900/20 flex-1"
                  >
                    Manage Profile
                  </button>
                  <button
                    onClick={logOut}
                    className="py-2 px-4 bg-emerald-900/50 text-red-400 text-xs font-semibold rounded hover:bg-red-900/30 hover:text-red-300 transition-colors border border-red-500/10 flex-1"
                  >
                    Sign Out
                  </button>
                </div>
              ...
              <div className="flex flex-col gap-2">
                <p className="text-xs text-emerald-400/80 mb-1 leading-relaxed">
                  Sign in to seamlessly synchronize your app preferences,
                  alarms, and daily trackers across multiple devices via
                  Firebase.
                </p>
                <button
                  onClick={() => setView("profile")}
        ...
        <div className="p-4 flex flex-col border-t border-emerald-800/40 rounded-b-xl">
          ...
          <div className="bg-emerald-950/50 p-3 rounded-lg border border-emerald-800/50">
            <p className="text-xs text-emerald-400/80 mb-3 leading-relaxed">
              Export your prayer history and app preferences as a JSON file you
              can keep securely offline.
            </p>
            <button

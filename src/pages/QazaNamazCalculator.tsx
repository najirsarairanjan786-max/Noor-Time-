...
import { ArrowLeft, Calculator, Plus, Minus, RotateCcw, AlertTriangle, X, Info } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="bg-emerald-600 rounded-3xl p-6 shadow-md mb-6 relative overflow-hidden text-white">
        ...
        <button onClick={() => setShowTimeTable(true)} className="mt-3 w-full bg-emerald-700/40 text-emerald-50 font-bold py-3 rounded-xl shadow-sm hover:bg-emerald-700/60 transition-colors active:scale-95 flex items-center justify-center gap-2"><Info className="w-5 h-5" /> View Qaza Time Table</button>
      </div>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-xl font-bold text-gray-900">Qaza Namaz Table</h3>
                  <button onClick={() => setShowTimeTable(false)} className="p-2 bg-gray-100 rounded-full text-gray-600">
                    <X className="w-5 h-5" />
                  </button>
                </div>
                
                <p className="text-sm text-gray-600 mb-6">
                  Only Fard and Witr prayers are offered as Qaza. Sunnah and Nafl are not offered as Qaza.
                </p>
                
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded-xl">
                    <span className="font-bold text-blue-900">Fajr</span>
                    <span className="text-blue-700 font-medium">2 Fard</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-amber-50 rounded-xl">
                    <span className="font-bold text-amber-900">Dhuhr</span>
                    <span className="text-amber-700 font-medium">4 Fard</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-orange-50 rounded-xl">
                    <span className="font-bold text-orange-900">Asr</span>
                    <span className="text-orange-700 font-medium">4 Fard</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-red-50 rounded-xl">
                    <span className="font-bold text-red-900">Maghrib</span>
                    <span className="text-red-700 font-medium">3 Fard</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-indigo-50 rounded-xl">
                    <span className="font-bold text-indigo-900">Isha</span>
                    <span className="text-indigo-700 font-medium">4 Fard, 3 Witr</span>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <input 
                      ...
                      className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 outline-none focus:ring-2 focus:ring-emerald-500 font-medium text-black"
                      placeholder="0"
                    />
                  </div>
                  <div className="flex items-center gap-4">

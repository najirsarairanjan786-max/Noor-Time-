        ...
        navigator.geolocation.getCurrentPosition(
          async (position) => {
            ...
            try {
              ...
              setSettings(prev => ({ ...prev, location: { lat, lng, name: city } }));
              resolve();
            } catch (e) {
              setSettings(prev => ({ ...prev, location: { lat, lng, name: "Current Location" } }));
              resolve();
            }
          },
          (error) => {
            ...
            setSettings(prev => ({ 
              ...prev, 
              location: { lat: 21.3891, lng: 39.8579, name: "Makkah, Saudi Arabia" },
              autoLocation: false 
            }));
            reject(error);
          },

sed -i '/{\/\* Grid \*\/}/i \
              ...
              <div\
                ...
                className="bg-white rounded-[18px] p-4 shadow-sm border-b-[8px] border-[#fb6060] flex items-center gap-4 cursor-pointer active:scale-95 transition-transform relative overflow-hidden"\
              >\
                ...
                <div className="w-[64px] h-[64px] bg-[#fff0f0] rounded-2xl flex items-center justify-center shrink-0 text-[#fb6060]">\
